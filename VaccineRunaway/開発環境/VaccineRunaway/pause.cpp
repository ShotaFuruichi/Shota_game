...
#define BUTTON_COLOR (0.0f)		//ボタン色初期値

#define MENU_POSX (250)			//メニュー画面中心からの距離X
#define MENU_POSY (350)			//メニュー画面中心からの距離Y
#define BUTTON_X (200)			//メニュー画面中心からのボタン距離X
...
int g_Menu = PAUSE_MENU_CONTINUE;							//選択中のボタン
